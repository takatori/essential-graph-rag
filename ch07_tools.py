...
Text: {input_text}
######################
Just give me the output, no need to define a function.
Output:
"""
...
def calculate_communities(neo4j_driver):
    try:
        neo4j_driver.execute_query("""CALL gds.graph.drop('entity')""")
    except:
        pass
    ...
    """)
    return [el.data() for el in records]
...
Output:
Here is the JSON-formatted report based on the given text:
json```"""
